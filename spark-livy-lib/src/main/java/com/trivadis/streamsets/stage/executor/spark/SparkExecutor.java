...
import static com.trivadis.streamsets.stage.executor.spark.Errors.SPARK_EXEC_00;
...
import com.trivadis.streamsets.stage.executor.spark.livy.LivyAppLauncher;
...
//              LOG.info(Utils.format("Spark application launched with app id: '{}'", appId));
              JOB_CREATED.create(getContext()).with(APP_ID, 1).createAndSend();
//            }
//        );
//        if (!appLauncher.9()) {
