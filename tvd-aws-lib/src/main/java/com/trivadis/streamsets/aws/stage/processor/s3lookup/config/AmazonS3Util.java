 ...
 */
package com.trivadis.streamsets.aws.stage.processor.s3lookup.config;
...
public class AmazonS3Util {
   ...
   */
/*  
  public static List<S3ObjectSummary> listObjectsLexicographically(
      AmazonS3 s3Client,
...
*/
   ...
   */
  /*
  public static List<S3ObjectSummary> listObjectsChronologically(
      AmazonS3 s3Client,
      S3ConfigBean s3ConfigBean,
      AntPathMatcher pathMatcher,
      S3Offset s3Offset,
  ...
  */
  ...
  public static Map<String, Object> getMetaData(S3Object s3Object) {
  ...
  public static S3Object getObjectRange(
      AmazonS3 s3Client,
      String bucket,
      String objectKey,
      long range,
  ...
  public static S3ObjectSummary getObjectSummary(AmazonS3 s3Client, String bucket, String objectKey) {
   ...
   */
  public static Integer parseOffset(S3Offset s3Offset) {
    Integer offset;
